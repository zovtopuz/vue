<template>
  ...
  <div class="card-content">
    ...
    <div class="input-field">
      ...
      >поле Email не має бути пустим</small>
      <small
      class="helper-text invalid"
    ...
    <div class="input-field">
      <input
          ...
          :class="{invalid: ($v.email.$dirty && $v.password.required) || ($v.password.$dirty && $v.password.minLenght)}">
      ...
      v-else-if="$v.password.$dirty && !$v.password.minLenght">
       пароль закороткий {{$v.password.$params.minLength.min}}, зараз він {{password.length}} </small>
    </div>
    <div class="input-field">
      <input
          id="name"
